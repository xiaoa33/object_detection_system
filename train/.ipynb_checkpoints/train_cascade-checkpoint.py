...
def parse_args():
    ...
    parser.add_argument("--max_pos", type=int, default=4000, help="训练集初始正样本数")
    parser.add_argument("--max_neg", type=int, default=10000, help="训练集初始负样本数")
...
def main():
    ...
    if os.path.exists(args.features_cache) and not args.force_recompute:
        ...
        if isinstance(imgs_pos_tr, list):
            ...
            imgs_pos_tr_flipped = np.flip(imgs_pos_tr, axis=2)
